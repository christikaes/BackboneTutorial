...
var i = require("underscore"),r; try {
r = require("jquery")
...
;}; e.emulateHTTP = false; e.emulateJSON = false; var a = function(t,e,r){
switch (t){
...
;}; var o = function(t,e){
if (i.isFunction(t)) {return t;} if (i.isObject(t) && !e._isModel(t)) {return l(t);} if (i.isString(t)) {return function(e){return e.get(t)};} return t
;}; var l = function(t){
var e = i.matches(t); return function(t){
return e(t.attributes)
;}
;}; var u = e.Events = {}; var c = /\s+/; var f = function(t,e,r,n,s){
var a = 0,h; if (r && typeof r === "object"){
...
if (i){
var n = t[e] || (t[e] = []); var s = r.context,a = r.ctx,h = r.listening; if (h){h.count++;} n.push({callback: i,context: s,ctx: s || a,listening: h});
} return t
...
if (!t) {return;} var s = 0,a; var h = n.context,o = n.listeners; if (!e && !r && !h){
...
var i,r = -1,n = t.length,s = e[0],a = e[1],h = e[2]; switch (e.length){
case 0:while (++r < n){(i=t[r]).callback.call(i.ctx);} return; case 1:while (++r < n){(i=t[r]).callback.call(i.ctx,s);} return; case 2:while (++r < n){(i=t[r]).callback.call(i.ctx,s,a);} return; case 3:while (++r < n){(i=t[r]).callback.call(i.ctx,s,a,h);} return; default:while (++r < n){(i=t[r]).callback.apply(i.ctx,e);} return
;}
...
;}; i.extend(y.prototype,u,{changed: null,validationError: null,idAttribute: "id",cidPrefix: "c",initialize: function(){},toJSON: function(t){
...
;},destroy: function(t){
t = t ? i.clone(t):{}; var e = this; var r = t.success; var n = t.wait; var s = function(){
...
;}; var w = {add: true,remove: true,merge: true}; var E = {add: true,remove: false}; var I = function(t,e,i){
i = Math.min(Math.max(i,0),t.length); var r = Array(t.length - i); var n = e.length; var s; for (s = 0; s < r.length; s++){r[s]=t[s+i];} for (s = 0; s < n; s++){t[s+i]=e[s];} for (s = 0; s < r.length; s++){t[s+n+i]=r[s]};
}; i.extend(x.prototype,u,{model: y,initialize: function(){},toJSON: function(t){
...
;}; var A = /\((.*?)\)/g; var C = /(\(\?)?:\w+/g; var R = /\*\w+/g; var j = /[\-{}\[\]+?.,\\\^$|#\s]/g; i.extend($.prototype,u,{initialize: function(){},route: function(t,r,n){
...
if (!this.routes) {return;} this.routes = i.result(this,"routes"); var t,e = i.keys(this.routes); while ((t = e.pop()) != null){
...
}; var M = /^[#\/]|\s+$/g; var O = /^\/+|\/+$/g; var U = /#.*$/; N.started = false; i.extend(N.prototype,u,{interval: 50,atRoot: function(){
...
t.hash = "#" + e
;}
}}); e.history = new N(); var q = function(t,e){
...
}; y.extend = x.extend = $.extend = k.extend = N.extend = q; var F = function(){
